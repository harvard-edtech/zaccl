...
var getCurrentOAuthAccessToken_1 = __importDefault(require("./getCurrentOAuthAccessToken"));
...
var JWT_EXPIRY_SEC_1 = __importDefault(require("../constants/JWT_EXPIRY_SEC"));
/* -------------------------- Function -------------------------- */
/**
...
var sendZoomRequest = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var method, params, zoomAPIConfig, headers, fullPath, accessToken, usingHarvardApigee, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                method = opts.method, params = opts.params, zoomAPIConfig = opts.zoomAPIConfig;
                headers = {};
                if (!(zoomAPIConfig.type === ZoomAPIConfigType_1.default.OAuth)) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, getCurrentOAuthAccessToken_1.default)(zoomAPIConfig)];
            case 1:
                accessToken = _a.sent();
